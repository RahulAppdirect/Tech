...
public class Inserttable {
	public static void Insert(UserDetails ud)
    {
        ...
        try
        {
            ...
            String query = "Insert into userinfo(firstName ,lastName, email, AccountIdentifier, Userid )"+"values(?,?,?,?,?)";
            ...
            String query1 = "Insert into company(name,phoneNumber,email, AccoountIdentifier, Userid , Website, Country)"+"values(?,?,?,?,?,?,?)";
           ...
           // prpstmt1.setString(2, ud.getCompanyemail());
            ...
            String query2 = "Insert into order1(EditionCode ,PricingDuration , AccoountIdentifier)"+"values(?,?,?)";
